...
```
New-UDAntdCopyToClipboard [[-Id] <String>] [[-ClassName] <String>] [-Disabled] [-Ghost] [[-HtmlType] <String>]
 [[-Icon] <String>] [-Loading] [[-Shape] <String>] [[-Size] <String>] [[-ButtonType] <String>] [-FullWidth]
 [[-Style] <Hashtable>] [[-Label] <String>] [[-TextToCopy] <String>] [<CommonParameters>]
```
