...
```
New-UDAntdInputPassword [[-Id] <String>] [[-ClassName] <String>] [-disabled] [[-OnPressEnter] <ScriptBlock>]
 [[-PlaceHolder] <String>] [[-Pattern] <String>] [-VisibilityToggle] [-Required] [[-Style] <Hashtable>]
 [<CommonParameters>]
```
...
### -VisibilityToggle
{{ Fill VisibilityToggle Description }}
