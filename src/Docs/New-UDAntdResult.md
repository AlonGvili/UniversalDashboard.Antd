...
```
New-UDAntdResult [[-Id] <String>] [[-Status] <String>] [[-Title] <String>] [[-SubTitle] <String>]
 [[-Icon] <Object>] [[-Extra] <Object>] [<CommonParameters>]
```
...
Parameter Sets: (All)
Aliases:
Accepted values: success, error, info, warning, 404, 403, 500
