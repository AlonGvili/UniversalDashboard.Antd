...
### Content (Default)
```
New-UDAntdDescriptionListItem [-Id <String>] [-ClassName <String>] [-Content <ScriptBlock>] [-Label <Object>]
 [-Span <String>] [-IsEndpoint] [-AutoRefresh] [-RefreshInterval <Int32>] [-Style <Hashtable>]
 [<CommonParameters>]
```

### Text
```
New-UDAntdDescriptionListItem [-Id <String>] [-ClassName <String>] [-Label <Object>] [-Text <String>]
 [-Span <String>] [-IsEndpoint] [-AutoRefresh] [-RefreshInterval <Int32>] [-Style <Hashtable>]
 [<CommonParameters>]
```
