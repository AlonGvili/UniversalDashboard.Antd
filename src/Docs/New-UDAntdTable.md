...
```
New-UDAntdTable [[-Id] <String>] [[-Column] <ScriptBlock>] [[-DataSource] <ScriptBlock>] [-Bordered]
 [-ShowHeader] [[-BodyStyle] <Hashtable>] [[-HeaderStyle] <Hashtable>] [[-Title] <String>] [-IsEndpoint]
 [<CommonParameters>]
```
